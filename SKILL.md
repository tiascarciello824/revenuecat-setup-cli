...
**Modalità Smart attivata di default!** ⚡

La skill rileva automaticamente la configurazione del tuo progetto e richiede solo:
- 🔑 RevenueCat API Key
- ✓ Conferma configurazione

**Tempo**: < 1 minuto | **Input**: 2 invece di 10+

### Modalità Alternative

```bash
# Smart Mode (default - consigliata)
/revenuecat-setup

# Interactive Mode (personalizzazione completa)
/revenuecat-setup --interactive

# Aiuto
/revenuecat-setup --help
```

## Quick Start

### Smart Mode (Consigliata)
```bash
...
**Auto-rileva:**
- ✅ Nome app, Bundle ID, Package Name
